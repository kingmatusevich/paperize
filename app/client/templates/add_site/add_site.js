...
/*****************************************************************************/
/* AddSite: Lifecycle Hooks */
/*****************************************************************************/
Template.AddSite.created = function () {
};

Template.AddSite.rendered = function () {
};

Template.AddSite.destroyed = function () {
};

var addSiteHooksObject = {
  // before: {
  ...
  after: {
    ...
    insert: function(error, result) {
      if (!error || error.message == 'notUnique'){
        //add site to user's subscriptions
      }
    }
  }
  //,
...
AutoForm.addHooks('addSiteForm', addSiteHooksObject, true);
